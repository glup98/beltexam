...
<body>
    ...
    <form:form class="d-inline-block" action="/boards/new" method="post" modelAttribute="board">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <button type="button" class="btn btn-danger"><a href="/home" class="text-white text-decoration-none">Cancel</a></button> <input type="submit" class="btn btn-info" value="Create"/>
    </form:form>
